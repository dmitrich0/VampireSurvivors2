...
namespace VampireSurvivors2.Model.Monsters
{
    internal class Monster : IAnimarable
    {
        ...
        public PointF CentralPosition => new PointF(Position.X + Size.Width / 2, Position.Y + Size.Height / 2);
        ...
        {
            if (!(vector.Length <= AttackRange)) return;
        ...
        public void TryToGetBookDamage(Vector vector)
        {
            ...
            {
                if (!(weapon is ProtectionBookWeapon bookWeapon)) continue;
